...
import type {
  ParagraphMixin,
  TextSegment
} from '@plugin/translators/text/paragraph/translateParagraphProperties';
...
export class Paragraph {
  ...
  private applySpacing(segment: TextSegment, node: ParagraphMixin): PenpotTextNode | undefined {
